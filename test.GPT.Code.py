...
# Target variable
data['Target'] = (data['Close'].shift(-1) > data['Close']).astype('int32')
...
def evaluate_individual(individual):
    ...
    return accuracy_score(y_test.to_pandas(), y_pred.to_pandas()),
...
feature_importances = pd.DataFrame({'Feature': features, 'Importance': importances.to_pandas()}).sort_values(by='Importance', ascending=False)
print("\nFeature Importances:")
